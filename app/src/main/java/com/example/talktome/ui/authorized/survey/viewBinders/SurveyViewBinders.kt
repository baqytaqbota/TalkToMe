package com.example.talktome.ui.authorized.survey.viewBinders
...
import kotlinx.android.synthetic.main.item_survey_checkable_grid_box.view.*
...
class GenderCheckListItemViewBinder(private val listener: ((UIGender) -> Unit)) :
    ...
    override fun onCreateViewHolder(
        inflater: LayoutInflater,
        parent: ViewGroup
    ) = ViewHolder(inflater.inflate(R.layout.item_survey_checkable_grid_box, parent, false))
